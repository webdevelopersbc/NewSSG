...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 004B170s8APW/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__vPMiM)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__gsRky)}
              role={"img"}
            />
          ),
